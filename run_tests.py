...
programs = {
    ...
    "R rjson": {
        ...
        "commands": [
            ...
            os.path.join(PARSERS_DIR, "test_rjson.r"),
        ],
    },
    "R jsonlite": {
        "url": "",
        "commands": [
            "/usr/local/bin/RScript",
            os.path.join(PARSERS_DIR, "test_jsonlite.r"),
        ],
    },
    "Obj-C JSONKit": {
        "url": "",
    ...
    "Obj-C Apple NSJSONSerialization": {
        ...
        "commands": [
            os.path.join(
                PARSERS_DIR, "test_ObjCNSJSONSerializer/bin/test_ObjCNSJSONSerializer"
            )
        ],
    },
    "Obj-C TouchJSON": {
    ...
    "Lua JSON 20160916.19": {
        ...
        "commands": [
            "/usr/local/bin/lua",
            os.path.join(PARSERS_DIR, "test_Lua_JSON/test_JSON.lua"),
        ],
    },
    "Lua dkjson": {
        ...
        "commands": [
            "/usr/local/bin/lua",
            os.path.join(PARSERS_DIR, "test_dkjson.lua"),
        ],
    },
    "Ruby": {
        "url": "",
    ...
    "Ruby regex": {
        ...
        "commands": [
            "/usr/bin/env",
            "ruby",
            os.path.join(PARSERS_DIR, "test_json_re.rb"),
        ],
    },
    "Ruby Yajl": {
    ...
    "Ruby Oj (strict mode)": {
        ...
        "commands": [
            "/usr/bin/env",
            "ruby",
            os.path.join(PARSERS_DIR, "test_oj_strict.rb"),
        ],
    },
    "Ruby Oj (compat mode)": {
        "url": "https://github.com/ohler55/oj",
        "commands": [
            "/usr/bin/env",
            "ruby",
            os.path.join(PARSERS_DIR, "test_oj_compat.rb"),
        ],
    },
    "Crystal": {
    ...
    "Python 3.5.2": {
        ...
        "commands": [
            "/usr/bin/env",
            "python3.5",
            os.path.join(PARSERS_DIR, "test_json.py"),
        ],
    },
    ...
    "Python simplejson 3.10": {  # pip install simplejson
        ...
        "commands": [
            "/usr/bin/python",
            os.path.join(PARSERS_DIR, "test_simplejson.py"),
        ],
    },
    ...
    "Python demjson 2.2.4 (py3)": {  # pip install demjson
        ...
        "commands": [
            "/usr/bin/env",
            "python3.5",
            os.path.join(PARSERS_DIR, "test_demjson.py"),
        ],
    },
    ...
    "Perl Cpanel::JSON::XS": {
        ...
        "commands": [
            "/usr/bin/perl",
            os.path.join(PARSERS_DIR, "test_cpanel_json_xs.pl"),
        ],
    },
    "Perl JSON::Parse": {
    ...
    "Perl MarpaX::ESLIF::ECMA404": {
        ...
        "commands": [
            "/usr/bin/perl",
            os.path.join(PARSERS_DIR, "test_marpax_eslif_ecma404.pl"),
        ],
    },
    "Perl Mojo::JSON": {
    ...
    "Swift Freddy 2.1.0": {
        "url": "",
        "commands": [
            os.path.join(PARSERS_DIR, "test_Freddy_2_1_0/bin/test_Freddy_2_1_0")
        ],
    },
    ...
    "C JSON Checker 20161111": {
        ...
        "commands": [
            os.path.join(
                PARSERS_DIR, "test_jsonChecker20161111/bin/jsonChecker20161111"
            )
        ],
    },
    "C++ sajson 20170724": {
    ...
    "C JSON Parser by udp": {
        ...
        "commands": [
            os.path.join(PARSERS_DIR, "test_json-parser/bin/test_json-parser")
        ],
    },
    "C++ nlohmann JSON 20190718": {
        ...
        "commands": [
            os.path.join(
                PARSERS_DIR, "test_nlohmann_json_20190718/bin/test_nlohmann_json"
            )
        ],
    },
    "C++ RapidJSON 20170724": {
        ...
        "commands": [
            os.path.join(PARSERS_DIR, "test_rapidjson_20170724/bin/test_rapidjson")
        ],
    },
    "Rust json-rust": {
    ...
    "Rust rustc_serialize::json": {
        ...
        "commands": [
            os.path.join(PARSERS_DIR, "test_json-rustc_serialize/rj/target/release/rj")
        ],
    },
    "Rust serde_json": {
    ...
    "Java json-simple 1.1.1": {
        ...
        "commands": [
            ...
            "-jar",
            os.path.join(
                PARSERS_DIR, "test_java_simple_json_1_1_1/TestJSONParsing.jar"
            ),
        ],
    },
    "Java org.json 2016-08-15": {
        ...
        "commands": [
            "/usr/bin/java",
            "-jar",
            os.path.join(PARSERS_DIR, "test_java_org_json_2016_08/TestJSONParsing.jar"),
        ],
    },
    "Java gson 2.7": {
        "url": "",
        "commands": [
            "/usr/bin/java",
            "-jar",
            os.path.join(PARSERS_DIR, "test_java_gson_2_7/TestJSONParsing.jar"),
        ],
    },
    "Java BFO v1": {
        ...
        "commands": [
            "/usr/bin/java",
            "-jar",
            os.path.join(PARSERS_DIR, "test_java_bfo/TestJSONParsing.jar"),
        ],
    },
    ...
    "Java Mergebase Java2Json 2019.09.09": {
        ...
        "commands": [
            ...
            "-jar",
            os.path.join(
                PARSERS_DIR, "test_java_mergebase_json_2019_09_09/TestJSONParsing.jar"
            ),
        ],
    },
    "Java nanojson 1.0": {
        ...
        "commands": [
            "/usr/bin/java",
            "-jar",
            os.path.join(PARSERS_DIR, "test_java_nanojson_1_0/TestJSONParsing.jar"),
        ],
    },
    "Java nanojson 1.1": {
        "url": "",
        "commands": [
            "/usr/bin/java",
            "-jar",
            os.path.join(PARSERS_DIR, "test_java_nanojson_1_1/TestJSONParsing.jar"),
        ],
    },
    "Java Actson 1.2.0": {
        ...
        "commands": [
            "/usr/bin/java",
            "-jar",
            os.path.join(PARSERS_DIR, "test_java_actson_1_2_0/TestJSONParsing.jar"),
        ],
    },
    ...
    "Qt JSON": {"url": "", "commands": [os.path.join(PARSERS_DIR, "test_qt/test_qt")]},
    "C ConcreteServer": {
    ...
    "Squeak JSON-tonyg": {
        ...
        "commands": [
            os.path.join(
                PARSERS_DIR, "test_Squeak_JSON_tonyg/Squeak.app/Contents/MacOS/Squeak"
            ),
            "-headless",  # <--optional
            os.path.join(
                PARSERS_DIR, "test_Squeak_JSON_tonyg/Squeak5.1-16549-32bit.image"
            ),
            "test_JSON.st",
        ],
    },
    ".NET Newtonsoft.Json 12.0.3": {
        ...
        "setup": [
            ...
            "--configuration",
            "Release",
            os.path.join(PARSERS_DIR, "test_dotnet_newtonsoft/app.csproj"),
        ],
        "commands": [
            "dotnet",
            os.path.join(
                PARSERS_DIR, "test_dotnet_newtonsoft/bin/Release/net5.0/app.dll"
            ),
        ],
    },
    ".NET System.Text.Json 5.0.0": {
        ...
        "setup": [
            ...
            "--configuration",
            "Release",
            os.path.join(PARSERS_DIR, "test_dotnet_system_text_json/app.csproj"),
        ],
        "commands": [
            "dotnet",
            os.path.join(
                PARSERS_DIR, "test_dotnet_system_text_json/bin/Release/net5.0/app.dll"
            ),
        ],
    },
    "Elixir Json": {
    ...
    "Elixir ExJSON": {
        ...
        "commands": [
            os.path.join(PARSERS_DIR, "test_elixir_exjson/test_elixir_exjson")
        ],
    },
    "Elixir Poison": {
        "url": "https://github.com/devinus/poison",
        "commands": [
            os.path.join(PARSERS_DIR, "test_elixir_poison/test_elixir_poison")
        ],
    },
    "Elixir Jason": {
    ...
    "Swift JSON 20170522": {
        ...
        "commands": [
            os.path.join(PARSERS_DIR, "test_json_swift_20170522/bin/json_swift")
        ],
    },
    "C++ nlohmann JSON 20190718": {
        "url": "https://github.com/nlohmann/json",
...
if __name__ == "__main__":
    ...
    generate_report(
        os.path.join(BASE_DIR, "results/parsing_pruned.html"),
